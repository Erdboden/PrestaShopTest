...
<?php }?>
    ...
    <?php if (isset($_smarty_tpl->tpl_vars['params']->value['type'])&&$_smarty_tpl->tpl_vars['params']->value['type']=='category_name') {?>
        <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['tr']->value[0]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
...
$_smarty_tpl->tpl_vars['commaSeparated']->value[] = $_smarty_tpl->tpl_vars['item']->value['name'];?>
    ...
    <?php if (isset($_smarty_tpl->tpl_vars['params']->value['type'])&&$_smarty_tpl->tpl_vars['params']->value['type']=='custom_meta') {?>
        <b>title:</b>
        <br>
        <?php echo $_smarty_tpl->tpl_vars['tr']->value['meta_title'];?>

        <br>
        <b>description:</b>
        <br>
        <?php echo $_smarty_tpl->tpl_vars['tr']->value['meta_description'];?>

        <br>
        <b>keywords:</b>
        <br>
        <?php echo $_smarty_tpl->tpl_vars['tr']->value['meta_keywords'];?>

        <br>
        <b>image alt:</b>
        <br>
        <?php echo $_smarty_tpl->tpl_vars['tr']->value['legend'];?>
