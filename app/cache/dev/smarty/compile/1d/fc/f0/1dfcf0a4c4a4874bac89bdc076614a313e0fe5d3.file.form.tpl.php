<?php /* Smarty version Smarty-3.1.19, created on 2018-03-26 16:23:53
         compiled from "/var/www/html/modules/grouperpro/views/templates/admin/_configure/grouper/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10108715975ab8f4690dd746-33233044%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1dfcf0a4c4a4874bac89bdc076614a313e0fe5d3' => 
    array (
      0 => '/var/www/html/modules/grouperpro/views/templates/admin/_configure/grouper/helpers/form/form.tpl',
      1 => 1522070602,
      2 => 'file',
    ),
    '1491790e51b09bb3f8e8c138d8833f225abfbc3a' => 
    array (
      0 => '/var/www/html/admin786elpbmm/themes/default/template/helpers/form/form.tpl',
      1 => 1519649749,
      2 => 'file',
    ),
    'a296b3f3ad19a8288e7b7d2dbeb378ee68b616c5' => 
    array (
      0 => '/var/www/html/admin786elpbmm/themes/default/template/helpers/form/form_group.tpl',
      1 => 1519649749,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10108715975ab8f4690dd746-33233044',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ab8f46a31f371_23895919',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ab8f46a31f371_23895919')) {function content_5ab8f46a31f371_23895919($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
<?php } else { ?>9<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?> col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='range_status') {?>
        <div class="form-group row">
            <div class="col-md-12">
                <p class="control-label pull-left"><strong><?php echo smartyTranslate(array('s'=>'For quantity orders:','mod'=>'grouperpro'),$_smarty_tpl);?>
</strong></p>
            </div>
            <div class="col-md-3 col-lg-3">
                <label class="control-label" for="order_from"><?php echo smartyTranslate(array('s'=>'Has at least X orders','mod'=>'grouperpro'),$_smarty_tpl);?>
</label>
                </br>
                <input placeholder="10" type="text" name="order_from" id="order_from" value="<?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value['order_from'])) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['fields_value']->value['order_from'],'html','UTF-8');?>
<?php }?>" class="fixed-width-lg">
            </div>
            <div class="col-md-3 col-lg-3">
                <label class="control-label" for="order_to"><?php echo smartyTranslate(array('s'=>'Has max Y orders','mod'=>'grouperpro'),$_smarty_tpl);?>
</label>
                </br>
                <input placeholder="20" type="text" name="order_to" id="order_to" value="<?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value['order_to'])) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['fields_value']->value['order_to'],'html','UTF-8');?>
<?php }?>" class="fixed-width-lg">
            </div>
            <div class="col-md-3 col-lg-3">
                <label class="control-label" for="order_status"><?php echo smartyTranslate(array('s'=>'Of status','mod'=>'grouperpro'),$_smarty_tpl);?>
 <?php echo smartyTranslate(array('s'=>'(if empty then all)','mod'=>'grouperpro'),$_smarty_tpl);?>
</label>
                </br>
                <select multiple name="order_status[]" id="order_status" class="chosen fixed-width-xl">
                    <?php if (isset($_smarty_tpl->tpl_vars['input']->value['orders_status_list'])&&$_smarty_tpl->tpl_vars['input']->value['orders_status_list']) {?>
                        <?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['orders_status_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value) {
$_smarty_tpl->tpl_vars['value']->_loop = true;
?>
                            <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value['order_status'])&&in_array($_smarty_tpl->tpl_vars['value']->value['id_order_state'],$_smarty_tpl->tpl_vars['fields_value']->value['order_status'])) {?>selected="selected"<?php }?> value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['value']->value['id_order_state'],'htmlall','UTF-8');?>
">
                                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['value']->value['name'],'htmlall','UTF-8');?>
        ...
        <div class="form-group row">
            <div class="col-md-12">
                <p class="control-label pull-left"><strong><?php echo smartyTranslate(array('s'=>'Or Orders sum:','mod'=>'grouperpro'),$_smarty_tpl);?>
</strong></p>
            </div>
            <div class="col-md-3 col-lg-3">
                <label class="control-label" for="order_sum_from"><?php echo smartyTranslate(array('s'=>'Has min Х','mod'=>'grouperpro'),$_smarty_tpl);?>
</label>
                </br>
                <input placeholder="10" type="text" name="order_sum_from" id="order_sum_from" value="<?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value['order_sum_from'])&&!empty($_smarty_tpl->tpl_vars['fields_value']->value['order_sum_from'])) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['fields_value']->value['order_sum_from'],'html','UTF-8');?>
<?php }?>" class="fixed-width-lg">
            </div>
            <div class="col-md-3 col-lg-3">
                <label class="control-label" for="order_sum_to"><?php echo smartyTranslate(array('s'=>'Has max Y','mod'=>'grouperpro'),$_smarty_tpl);?>
</label>
                </br>
                <input placeholder="20" type="text" name="order_sum_to" id="order_sum_to" value="<?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value['order_sum_to'])&&!empty($_smarty_tpl->tpl_vars['fields_value']->value['order_sum_to'])) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['fields_value']->value['order_sum_to'],'html','UTF-8');?>
<?php }?>" class="fixed-width-lg">
            </div>
            <div class="col-md-3 col-lg-3">
                <label class="control-label" for="order_currency"><?php echo smartyTranslate(array('s'=>'In Currency','mod'=>'grouperpro'),$_smarty_tpl);?>
</label>
                </br>
                <select multiple name="order_currency[]" id="order_currency" class="chosen fixed-width-xl">
                    <?php if (isset($_smarty_tpl->tpl_vars['input']->value['currencies'])&&$_smarty_tpl->tpl_vars['input']->value['currencies']) {?>
                        <?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['currencies']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value) {
$_smarty_tpl->tpl_vars['value']->_loop = true;
?>
                            <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value['order_currency'])&&!empty($_smarty_tpl->tpl_vars['fields_value']->value['order_currency'])&&in_array($_smarty_tpl->tpl_vars['value']->value['id_currency'],$_smarty_tpl->tpl_vars['fields_value']->value['order_currency'])) {?>selected="selected"<?php }?> value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['value']->value['id_currency'],'htmlall','UTF-8');?>
">
                                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['value']->value['name'],'htmlall','UTF-8');?>
            ...
            <div class="col-md-3 col-lg-3">
                <label class="control-label" for="order_sum_status"><?php echo smartyTranslate(array('s'=>'Of status','mod'=>'grouperpro'),$_smarty_tpl);?>
</label>
                </br>
...
$_smarty_tpl->tpl_vars['value']->_loop = true;
?>
                            <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value['order_sum_status'])&&!empty($_smarty_tpl->tpl_vars['fields_value']->value['order_sum_status'])&&in_array($_smarty_tpl->tpl_vars['value']->value['id_order_state'],$_smarty_tpl->tpl_vars['fields_value']->value['order_sum_status'])) {?>selected="selected"<?php }?> value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['value']->value['id_order_state'],'htmlall','UTF-8');?>
">
                                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['value']->value['name'],'htmlall','UTF-8');?>
    ...
    <?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='needmodule') {?>
        <div class="form-group">
            <div class="col-md-8 col-lg-8 control-label">
                <p align="left">
                    <?php echo smartyTranslate(array('s'=>'"Cron Tasks Manager" module is required, but not installed!','mod'=>'grouperpro'),$_smarty_tpl);?>

                </p>
                <p align="left">
                    <?php echo smartyTranslate(array('s'=>'Please install the module: "Cron Tasks Manager" by PrestaShop','mod'=>'grouperpro'),$_smarty_tpl);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '10108715975ab8f4690dd746-33233044');
content_5ab8f469db1192_91309936($_smarty_tpl);
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2018-03-26 16:23:53
         compiled from "/var/www/html/admin786elpbmm/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5ab8f469db1192_91309936')) {function content_5ab8f469db1192_91309936($_smarty_tpl) {?>
