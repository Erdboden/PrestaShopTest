<?php /* Smarty version Smarty-3.1.19, created on 2018-04-04 17:37:03
         compiled from "/var/www/html/modules/gshoppingfeed/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15807909285ac4e30fb4ebd1-71497939%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '49e89b19a2276329fa60d4022cf1d7be7d8d0311' => 
    array (
      0 => '/var/www/html/modules/gshoppingfeed/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1522397475,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '15807909285ac4e30fb4ebd1-71497939',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ac4e310c305e5_31723788',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ac4e310c305e5_31723788')) {function content_5ac4e310c305e5_31723788($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '15807909285ac4e30fb4ebd1-71497939');
content_5ac4e31086cdb5_30243718($_smarty_tpl);
...
" ></i> <?php }?><?php echo $_smarty_tpl->tpl_vars['btn']->value['title'];?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['submit_action']->value=='submitGshoppingfeedModule') {?>
        <div class="panel text-center rev_before">
            <span data-tab="gshoppingfeed_action" class="step-title tab"><?php echo smartyTranslate(array('s'=>'Step 2','mod'=>'gshoppingfeed'),$_smarty_tpl);?>
</span>
            <p class="help-block">
                <?php echo smartyTranslate(array('s'=>'Configuration and filter generation template','mod'=>'gshoppingfeed'),$_smarty_tpl);?>

            </p>
        </div>
        <?php if ((isset($_smarty_tpl->tpl_vars['fields']->value['form']['form']['anchor'])&&$_smarty_tpl->tpl_vars['fields']->value['form']['form']['anchor']==1)) {?>
            <script type="text/javascript">
                openGSFConfigurationList(<?php if ((isset($_smarty_tpl->tpl_vars['fields']->value['form']['form']['getLink'])&&$_smarty_tpl->tpl_vars['fields']->value['form']['form']['getLink']==1)) {?>1<?php } else { ?>0<?php }?>);
            </script>
        <?php } elseif ((isset($_smarty_tpl->tpl_vars['fields']->value['form']['form']['newForm'])&&$_smarty_tpl->tpl_vars['fields']->value['form']['form']['newForm']==1)) {?>
            <script type="text/javascript">
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2018-04-04 17:37:04
         compiled from "/var/www/html/admin786elpbmm/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5ac4e31086cdb5_30243718')) {function content_5ac4e31086cdb5_30243718($_smarty_tpl) {?>
