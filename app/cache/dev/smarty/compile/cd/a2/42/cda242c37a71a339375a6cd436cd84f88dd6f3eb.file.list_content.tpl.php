...
<?php /*%%SmartyHeaderCode:8500266975ac5dda9acb3e9-99405032%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '8500266975ac5dda9acb3e9-99405032',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ac5ddaa039ac1_34398232',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ac5ddaa039ac1_34398232')) {function content_5ac5ddaa039ac1_34398232($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
?>
    ...
    <?php if (isset($_smarty_tpl->tpl_vars['params']->value['type'])&&$_smarty_tpl->tpl_vars['params']->value['type']=='taxonomy_lists') {?>
    <td class="pointer text-right">
        <input type="hidden" value="<?php echo intval($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['identifier']->value]);?>
" name="ind" class="ind">
    <?php } elseif (isset($_smarty_tpl->tpl_vars['params']->value['type'])&&$_smarty_tpl->tpl_vars['params']->value['type']=='fast_generation') {?>
    <td class="pointer center">
        <a class="btn btn-primary" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['current_index']->value,'html','UTF-8');?>
...
&amp;generationlink=1">
            <?php echo smartyTranslate(array('s'=>'Show link','mod'=>'gshoppingfeed'),$_smarty_tpl);?>
...
'">
 ...
 $_from = $_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
    ...
    <?php } elseif (isset($_smarty_tpl->tpl_vars['params']->value['type'])&&$_smarty_tpl->tpl_vars['params']->value['type']=='taxonomy_exist') {?>

        <?php if ((bool)$_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]==true) {?>
            <span class="label color_field"
                  style="background-color:#CCCC99;color:#383838;min-width: 120px; display: inline-block">
                <?php echo smartyTranslate(array('s'=>'Available','mod'=>'gshoppingfeed'),$_smarty_tpl);?>

            </span>
        <?php } else { ?>
            <span class="label color_field"
                  style="background-color:red;color:white;min-width: 120px; display: inline-block">
                <?php echo smartyTranslate(array('s'=>'No exist','mod'=>'gshoppingfeed'),$_smarty_tpl);?>

            </span>
        <?php }?>

    <?php } elseif ((isset($_smarty_tpl->tpl_vars['params']->value['type'])&&$_smarty_tpl->tpl_vars['params']->value['type']=='taxonomy_lists')) {?>
        <span class="btn btn-default change_taxonomy">
            <?php echo smartyTranslate(array('s'=>'Edit','mod'=>'gshoppingfeed'),$_smarty_tpl);?>

        </span>
        <span class="btn btn-default change_taxonomy_save hidden">
            <?php echo smartyTranslate(array('s'=>'Save','mod'=>'gshoppingfeed'),$_smarty_tpl);?>
