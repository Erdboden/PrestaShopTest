<?php /* Smarty version Smarty-3.1.19, created on 2018-04-05 15:02:07
         compiled from "/var/www/html/modules/gshoppingfeed/views/templates/admin/_configure/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4423422065ac6103f800873-73716806%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6790a22ba27f9dbf416567661d33fbe1bb6db2e4' => 
    array (
      0 => '/var/www/html/modules/gshoppingfeed/views/templates/admin/_configure/helpers/list/list_header.tpl',
      1 => 1522397475,
      2 => 'file',
    ),
    'd7c118ccc95da2315b0b2afabdfe9ce7a9daa94c' => 
    array (
      0 => '/var/www/html/admin786elpbmm/themes/default/template/helpers/list/list_header.tpl',
      1 => 1519649749,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4423422065ac6103f800873-73716806',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ac6103fc6df30_35371968',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ac6103fc6df30_35371968')) {function content_5ac6103fc6df30_35371968($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/vendor/prestashop/smarty/plugins/function.math.php';
?>
...
<?php }?>
    ...
    <?php if (($_smarty_tpl->tpl_vars['list_id']->value=='gshoppingfeed_taxonomy')) {?>
        <div class="panel text-center step_container_1">
            <span data-tab="gshoppingfeed_taxonomy" class="step-title tab"><?php echo smartyTranslate(array('s'=>'Step 1','mod'=>'gshoppingfeed'),$_smarty_tpl);?>
</span>
            <p class="help-block">
                <?php echo smartyTranslate(array('s'=>'Associate google-taxonomy categories','mod'=>'gshoppingfeed'),$_smarty_tpl);?>

            </p>
        </div>
    <?php } elseif (($_smarty_tpl->tpl_vars['list_id']->value=='gshoppingfeed_taxonomy_lang_list')) {?>
        <div class="panel text-center step_container_1">
            <span data-tab="gshoppingfeed_taxonomy_lang_list" class="step-title tab"><?php echo smartyTranslate(array('s'=>'Taxonomy Addons configurations','mod'=>'gshoppingfeed'),$_smarty_tpl);?>
</span>
            <p class="help-block">
                <?php echo smartyTranslate(array('s'=>'Google Taxonomy set','mod'=>'gshoppingfeed'),$_smarty_tpl);?>
...
";
    ...
    <?php if (($_smarty_tpl->tpl_vars['list_id']->value=='gshoppingfeed_taxonomy'&&count($_smarty_tpl->tpl_vars['languages']->value)>=1)) {?>
        <div class="form-group">
            <label class="control-label col-lg-2">
                &raquo; <?php echo smartyTranslate(array('s'=>'Select language','mod'=>'gshoppingfeed'),$_smarty_tpl);?>
 :
            </label>
            <div class="col-lg-3">
...
?>
                            <option <?php if (isset($_smarty_tpl->tpl_vars['id_language']->value)&&$_smarty_tpl->tpl_vars['id_language']->value==$_smarty_tpl->tpl_vars['language']->value['id_lang']) {?>selected="selected"<?php }?> value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['language']->value['id_lang'],'htmlall','UTF-8');?>
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['language']->value['name'],'htmlall','UTF-8');?>

                                - (<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['language']->value['language_code'],'htmlall','UTF-8');?>
)
                            </option>
                        <?php } ?>
                    </select>
        ...
        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('reloadTaxonomyUri'=>$_smarty_tpl->tpl_vars['update_path']->value),$_smarty_tpl);?>
